...
func NewIndexer(tempDir string) (*Indexer, error) {
	idx := &Indexer{}
	var err error
	idx.docTxtFile, err = os.CreateTemp(tempDir, "doctmp")
	if err != nil {
		return nil, err
	}
	idx.wordTxtFile, err = os.CreateTemp(tempDir, "wordtmp")
	if err != nil {
		return nil, err
	}
	idx.docCdbFile, err = os.CreateTemp(tempDir, "doccdb")
	if err != nil {
		return nil, err
	}
	idx.wordCdbFile, err = os.CreateTemp(tempDir, "wordcdb")
	if err != nil {
		return nil, err
	}
